...
print("1st var is string, secomnd is Int, and third is string")

print("Happy Birthday to you")
print("Happy Birthday to you")
print("Happy Birthday dear somebody")
print("Happy Birthday to you")

print("this sentence has a {} in it")
