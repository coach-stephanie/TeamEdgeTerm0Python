...
friends = ["Ransom", "Steven", "Maya", "JC", "Chantel"]
print(friends)
...
random_thought = [True, 1, "Two", 3, 4]
print(random_thought)
#-->TODO: Declare and log two more lists with whatever you want. 
one_more_list = ["whatever", "you", "want", "in", "list"]
print(one_more_list)
two_more_list = ["these", "are", "five", "single", "words"]
print(two_more_list)
...
parent = [empty_list, names, friends, numbers, five_num, random_stuff, random_thought, one_more_list, two_more_list, bestfriend, parent_list]
print(parent)
print("------------------- CHALLENGE 5 -------------------")
...
song_fav = ["uber everywhere", "too late", "potato salad", "all mine"]
#-->TODO: Add 2-3 more songs using .append() and print both before and after.
song_fav.append("Taco Bell N")
song_fav.append("Stick")
print(song_fav)
